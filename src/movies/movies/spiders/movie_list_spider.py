...
class MovieListSpider(scrapy.Spider):
    ...
    def parse_year(self, response, year):
        ...
        link_list = response.selector.xpath(
            '//div[@class="mw-parser-output"]/ul[preceding::h2[./span[@id="2022_films"]]]/li/a[contains(text(), "List of")]/@href').getall()
    ...
    def parse_film_list(self, response, year):
        ...
        link_list = response.selector.xpath(
            '//ul[preceding::h2[./span[@id="Notable_films_released_in_1990"]] and following-sibling::h2[./span['
